        ...
        <div class="border-dashed view-height w-100">
            <div class="mt-4 ml-4 mr-4">
                <div class="row border-bottom border-3">
                    ...
                    <div class="col d-flex justify-content-end mb-2"><a href="/app/recipe/list" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Powrót</a></div> <%--dodany link do istniejącej strony !!!--%>
                </div>
                ...
                <table class="table borderless">
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-7">${recipeDetails.Recipe.description}</td>
                    </tr>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                        <td class="col-7">
                            ${recipeDetails.Recipe.preparationTime}
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <div class="row d-flex">
                    <div class="col-5 p-4">
                        <p>${recipeDetails.Recipe.preparation}</p>
                    </div>
                    <div class="col-2"></div>
